...
DO I=1,INEEDT
    ...
    IF (DG == 1 .AND. RECONSTRUCT_HIGHER_ORDER_DG_DOFS_BOOLEAN == 1) THEN
        ...
        ALLOCATE(IEXSOLHIR(I)%BASIS_NEIGHBOR_CENTER(IRECEXS(I)%MUCHTHEYNEED(1), NUM_DG_RECONSTRUCT_DOFS - 1))
...
DO I=1,TNEEDT
	...
	IF (DG == 1 .AND. RECONSTRUCT_HIGHER_ORDER_DG_DOFS_BOOLEAN == 1) THEN
        ...
        ALLOCATE(IEXSOLHIS(I)%BASIS_NEIGHBOR_CENTER(IRECEXS(I)%MUCHTHEYNEED(1), NUM_DG_RECONSTRUCT_DOFS - 1))
...
DO I=1,INDL
    ...
    ! 	ALLOCATE(IEXBOUNDHIRR(I)%vertpp(IEXCHANGER(I)%MUCHINEED(1),i_cnt2))
        ...
        IF (DG == 1)THEN
            ...
            ALLOCATE(IEXBOUNDHIR(I)%U_CENTER_DG(IEXCHANGER(I)%MUCHINEED(1), NOF_VARIABLES, NUM_DG_DOFS))
        END IF
...
DO I=1,TNDL
	IF (ITESTCASE.Le.3)THEN
        ...
        IF (DG == 1)THEN
            ...
            ALLOCATE(IEXBOUNDHIS(I)%U_CENTER_DG(IEXCHANGER(I)%MUCHINEED(1), NOF_VARIABLES, NUM_DG_DOFS))
        END IF
