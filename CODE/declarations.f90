...
REAL:: SCHMIDT_LAM
REAL::SCHMIDT_TURB
real::tolsmall,TOLBIG,allresdt,tz1,TOL_PER
REAL:: ANGLE_PER
...
REAL::KINIT_SRF   
REAL,DIMENSION(3)::point1_in,point2_in
real:: Radius, MRF_ROT
...
!$OMP THREADPRIVATE(SOURCE_T2,SRF_SPEED,SRF_SPEEDROT,SRF,point1_GL,point2_GL)
