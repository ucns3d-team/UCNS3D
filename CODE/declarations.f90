...
INTEGER::RECONSTRUCT_HIGHER_ORDER_DG_DOFS_BOOLEAN
...
REAL::Z1,x1c,y1c,h1c					!Z1 COORDINATE FOR BASIS FUNCTION COMPUTATION OF POLYNOMIALS
...
REAL,ALLOCATABLE,DIMENSION(:,:,:,:)::MASS_MATRIX_CENTERS !N, I_ELEM, I_DOF, J_DOF
REAL,ALLOCATABLE,DIMENSION(:,:,:,:)::INV_MASS_MATRIX !N, I_ELEM, I_DOF, J_DOF
real::a_rot,c_rot,b_rot,root_rot,sheartemp
REAL,ALLOCATABLE,DIMENSION(:)::WEIGHT_T2

!$OMP THREADPRIVATE(MP_SOURCE1,MP_SOURCE2,MP_SOURCE3,b_char,x_Char,INSTEN,llx,varcons,pointx,ba_char,a_char,ICONS_S,ICONS_E,compwrt,ILOCALALLELGD,ILOCALALLELG3,STCON,STCONC,STCONS,STCONG,ISOSA,IX,IFSAT,IISTART,SHEARTEMP,IMAX,NUMBER_OF_NEI,b_code,INUM,angle1,angle2,IDEG,n_node,inump,INUMO,inumo2,ideg2,m2,inump2,imax2,A_ROT,C_ROT,B_ROT,ROOT_ROT,ANGLEFACEX,ANGLEFACEY,voltemp,VISCOTS)
...
!$OMP THREADPRIVATE(TEMPFL,lamc,TEMPFR,FLSTAR,FRSTAR,ULSTAR,UrSTAR,TEMPUL,TEMPUR,FL,eddyfl,eddyfr,FR,RML,RMR,NODES_LIST,VEXT,ELTYPE,ELEM_DEC,ELEM_LISTD,DETERJACS,JACS,INVERSEJACS,SOLUTION_INTEG2,LEFTV,RIGHTV,CORDS,VISCL,LAML,ETVM,TURBMV)
...
!$OMP THREADPRIVATE(NORMALVECT,DELTAF,VELNorMAL,MODEU,Q,R,QT,WEFF,MATRIX_A,LSQM,XCC,vgg,VELLSQMAT,MATRIX_SOLUTION,MATRIXFACE,JUSTCHECK,PDIM,XQR,VQR,VQR1,PQR,INVR,LSCQM,LSCQM2,ivgt,R_dg,LSCQM_dg,INVRFF_dg,QTFF_dg,RFF_dg,QFF_dg)
...
TYPE EXCHANGE_SOLHI
    ...
    REAL,ALLOCATABLE,DIMENSION(:,:,:)::SOL_DG   !ARRAY TO HOLD THE VALUES TO BE SEND/RECEIVED
	REAL,ALLOCATABLE,DIMENSION(:,:)::DELTA_XYZ
	REAL,ALLOCATABLE,DIMENSION(:,:)::BASIS_NEIGHBOR_CENTER
...
TYPE::ELEMENT_NUMBER
	...
	REAL,ALLOCATABLE,DIMENSION(:)::TAYLOR_INTEGRAL
