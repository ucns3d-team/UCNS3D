...
REAL::GAMMA,GAMMAL,GAMMAR 					!GAS CONSTANT
...
REAL,ALLOCATABLE,DIMENSION(:)::gamma_IN,MP_IE,MP_A,MP_AR,MP_R,MP_R_IN,MP_A_IN !MULTIPHASE COMPONENTS	
...
!$OMP THREADPRIVATE(CLEFT,cleft_rot,gammaL,GAMMAR,MP_IE,MP_AR,MP_R,MP_A,cright,cright_rot,sl,sr,sm,HLLCFLUX)
