...
INTEGER::NUM_DG_DOFS !NUMBER OF DEGREES OF FREEDOM FOR DG POLYNOMIAL APPROXIMATION (IDEGFREE + 1)
INTEGER::NUM_DG_RECONSTRUCT_DOFS !NUMBER OF DEGREES OF FREEDOM FOR DG ORDER + 1, INCLUDING NUM_DG_DOFS
...
TYPE EXCHANGE_BOUNDHI    
	...
	REAL,ALLOCATABLE,DIMENSION(:,:,:)::U_CENTER_DG
