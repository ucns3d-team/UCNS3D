...
!$OMP THREADPRIVATE(TEMPFL,SRF_SPEED,srf_speedrot,lamc,SRF	,TEMPFR,FLSTAR,FRSTAR,ULSTAR,UrSTAR,TEMPUL,TEMPUR,FL,eddyfl,eddyfr,FR,RML,RMR,NODES_LIST,VEXT,ELTYPE,ELEM_DEC,ELEM_LISTD,DETERJACS,JACS,INVERSEJACS,LEFTV,RIGHTV,CORDS,VISCL,LAML,ETVM,TURBMV)
