...
GRADSS(1:IDEGFREE,NOF_VARIABLES+TURBULENCEEQUATIONS+PASSIVESCALAR),VORTET1(1:dims,1:dims),consmatrix(1:NUMBEROFPOINTS2*6,1:idegfree),consmatrixc(1:NUMBEROFPOINTS2*6,1:idegfree),&
LAMC(TYPESTEN),GRAD3AL(IDEGFREE),GRAD5ALc(IDEGFREE,nof_variables))
...
ALLOCATE(USOL(NOF_VARIABLES+TURBULENCEEQUATIONS+PASSIVESCALAR,1:6,1:NUMBEROFPOINTS2),&
PSI(NOF_VARIABLES+TURBULENCEEQUATIONS+PASSIVESCALAR,1:6,1:NUMBEROFPOINTS2),UTEMP(IMAXDEGFREE+1,1:kkd),UTMIN(NOF_VARIABLES+TURBULENCEEQUATIONS+PASSIVESCALAR),&
UTMAX(NOF_VARIABLES+TURBULENCEEQUATIONS+PASSIVESCALAR))
...
,WENOO(1:kkd,1:TYPESTEN),WENO(1:kkd+TURBULENCEEQUATIONS+PASSIVESCALAR,1:TYPESTEN),WENO2(1:kkd,1:TYPESTEN),GRADSSL(1:IDEGFREE,1:NOF_VARIABLES),GRADCHARV(1:kkd,1:TYPESTEN,0:IDEGFREE),&
FINDW(kkd,0:IDEGFREE,6,2),FINDW_CHAR(kkd,0:IDEGFREE,6,2,1:TYPESTEN),LIMITEDDW_CHAR(1:kkd,0:IDEGFREE,1:TYPESTEN),&
