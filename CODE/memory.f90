...
allocate(sb(idegfree))
ALLOCATE(VVr1(alls),VVr2(alls),VVr3(alls),VVR4(ALLS),VVwg(alls),VVnpox(igqrules),POX(1),POY(1),VVnpoy(igqrules),VVnpoz(igqrules),VVwpox(igqrules),VVwpoy(igqrules),VVwpoz(igqrules),SRF_SPEED(NOF_VARIABLES),SRF_SPEEDROT(NOF_VARIABLES))
...
ALLOCATE(MATRIX_A(1:IMAXDEGFREE,1:IDEGFREE),SOURCE_T(TURBULENCEEQUATIONS),SOURCE_T2(NOF_VARIABLES),LSQM(1:IMAXDEGFREE,1:IDEGFREE-1),VELLSQMAT(1:IDEGFREE-1,1:IDEGFREE-1),MATRIX_SOLUTION(1:IDEGFREE,1:1)&
