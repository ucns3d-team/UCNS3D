...
!         U_C(I)%VALDG(1,1:NOF_VARIABLES,:)=U_C(I)%VALDG(2,1:NOF_VARIABLES,:) - DT * TRANSPOSE(MATMUL(m_1(i)%val(:,:), RHS(I)%VALDG(:,1:NOF_VARIABLES)))
	  ...
	  RHS(I)%VALDG(1:NUM_DG_DOFS,1:NOF_VARIABLES),&
        ...
        U_C(I)%VALDG(1,1:NOF_VARIABLES,:)=U_C(I)%VALDG(2,1:NOF_VARIABLES,:) - DT * TRANSPOSE(RHS(I)%SOL_MM_DG)
...
!         U_C(I)%VALDG(1,1:NOF_VARIABLES,:)=TO4*U_C(I)%VALDG(2,1:NOF_VARIABLES,:) + OO4*U_C(I)%VALDG(3,1:NOF_VARIABLES,:) - OO4*DT* TRANSPOSE(MATMUL(m_1(i)%val(:,:), RHS(I)%VALDG(:,1:NOF_VARIABLES)))
	  ...
	  RHS(I)%VALDG(1:NUM_DG_DOFS,1:NOF_VARIABLES),&
        ...
        U_C(I)%VALDG(1,1:NOF_VARIABLES,:)=TO4*U_C(I)%VALDG(2,1:NOF_VARIABLES,:) + OO4*U_C(I)%VALDG(3,1:NOF_VARIABLES,:) - OO4*DT * TRANSPOSE(RHS(I)%SOL_MM_DG)
...
!   call SOLUTION_INTEG_S
!   call SOLUTION_INTEG_W
!
!   U_CS(I)%VAL(1,:)=SOLUTION_INTEG_STRONG
!   U_CW(I)%VAL(1,:)=SOLUTION_INTEG_WEAK
!   END IF
...
! 				END IF
			    ...
			    IF ((initcond.eq.405).or.(initcond.eq.422).or.(initcond.eq.411))THEN
