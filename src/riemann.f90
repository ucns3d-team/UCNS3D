...
Subroutine HLL_RIEMANN_SOLVER(N,CLEFT_ROT,CRIGHT_ROT,HLLCFLUX,ROTVL,ROTVR,GAMMA,SL,SR,SM)
!> @brief
!> HLLC Riemann solver in 3D
	...
	real,dimension(1:nof_variables)::FHLL
...
Subroutine HLL_RIEMANN_SOLVER2d(N,CLEFT_ROT,CRIGHT_ROT,HLLCFLUX,ROTVL,ROTVR,GAMMA,SL,SR,SM)
!> @brief
!> HLLC Riemann solver in 2D
	IMPLICIT NONE
	INTEGER,INTENT(IN)::N
