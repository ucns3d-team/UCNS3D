...
KMAXE=XMPIELRANK(N)
allocate (ilocal_recon5(KMAXE))

DO I=1,KMAXE	!for all the interior elements
...
ALLOCATE (ILOCAL_RECON5(I)%GRADIENTSTURB_wall(6*numberofpoints2,IDEGFREE,0+TURBULENCEEQUATIONS+PASSIVESCALAR)) !10
ALLOCATE (ILOCAL_RECON5(I)%GRADIENTSTEMP_wall(6*numberofpoints2,IDEGFREE))!10
ALLOCATE (ILOCAL_RECON5(I)%VELOCITYDOF_wall(6*numberofpoints2,3,IDEGFREE))!30
end if
...
ALLOCATE (ILOCAL_RECON5(I)%GRADIENTSTURB_wall(4*numberofpoints2,IDEGFREE,0+TURBULENCEEQUATIONS+PASSIVESCALAR)) !10
ALLOCATE (ILOCAL_RECON5(I)%GRADIENTSTEMP_wall(4*numberofpoints2,IDEGFREE))!10
ALLOCATE (ILOCAL_RECON5(I)%VELOCITYDOF_wall(4*numberofpoints2,2,IDEGFREE))!30
end if
