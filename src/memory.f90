...
subroutine omp_map_first(n)
  ...
  !$omp target enter data map(alloc: jtotal, jtotal1, jtotal2, jtotal3, jump_cond1, jump_cond2, jump_cond3, kappa)
  !$omp target update to(jtotal, jtotal1, jtotal2, jtotal3, jump_cond1, jump_cond2, jump_cond3, kappa)
