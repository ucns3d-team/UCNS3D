...
integer::jtotAL,JTOTAL1,JTOTAL2,JTOTAL3,compwrt,varcons,pointx,llx,fastmovie,movement,TYP_COUNTN_GLOBAL,TYP_COUNTN,TYP_COUNTN_GLOBAL_W,TYP_COUNTN_w
...
INTEGER::UNSTEADY				!UNSTEADY SIMULATION
...
INTEGER,ALLOCATABLE,DIMENSION(:)::IWHICHSTEN,XSIZE,XGO,xgo_v,CHUNK_SIZE	!ALLOCATABLE INDEX FOR DESCRIBING WHICH STENCIL IS CONSIDERED WITHIN THE DIRECTIONAL STENCIL CONSTRUCTION ROUTINE
...
INTEGER,ALLOCATABLE,DIMENSION(:)::IX,XMPIALL,OFFSET,xmpiwall,woffset,xmpi_re,xmpi_wre,offset_v,XMPIALL_v		!allocatable index FOR STENCIL ROUTINE
