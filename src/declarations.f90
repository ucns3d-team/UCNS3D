...
!$omp declare target (mp_brok_c, mp_janaf, mp_m, mp_modelc, mp_pinf, mp_r_in, mp_thigh_in, mp_tlow_in, mp_tmid_in, mrf_rot_gl)
...
!$omp declare target (prace_t9, prace_tx1, prace_tx2, prace_tx3, press_outlet, prev_turbmodel, qp_array_qp_weight, qp_array_x, qp_array_y, qp_array_z)
...
!$omp declare target (sht_rg, sigma_k1, sigma_k2, sigma_om1, sigma_om2, sigma_phi, source_active, srf_origin, srf_velocity, st_n_cpu)
!$omp declare target (st_n_threads, stencil_io, taylor_ens, taylor_ensx, temp_model, thread_n, tol_per, typ_countn, typ_countn_global, typ_countn_global_w)
...
!$omp declare target (lmach, lowmem, lowmemory, lwci1, modeio, momentx, momenty, momentz, mood, movement)
