...
TYPE(A_EXCHANGE),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::IEXCHANGER,IEXCHANGES
...
!> of different size
	...
	INTEGER,ALLOCATABLE,DIMENSION(:),INTENT(IN)::XMPIELRANK
	TYPE(A_EXCHANGE),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::IEXCHANGES
	TYPE(A_EXCHANGE),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::IEXCHANGER
	INTEGER,ALLOCATABLE,DIMENSION(:,:,:,:),INTENT(IN)::ILOCALSTENCIL
	INTEGER,INTENT(IN)::NUMNEIGHBOURS,ISCHEME
	TYPE(A_RECEX),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::IRECEXR		!RECEIVE ELEMENTS DUE TO STENCILS
	TYPE(A_RECEX),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::IRECEXS	
	...
	TYPE(A_LISTSTENCILS),ALLOCATABLE,DIMENSION(:)::ILISTSTEN
	TYPE(A_LISTGOG),ALLOCATABLE,DIMENSION(:)::ILISTGOG,ILISTSIDE,ILISTGLO,ILISTQ
