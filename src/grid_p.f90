...
TYPE(A_ELEMENT_NUMBER),ALLOCATABLE,DIMENSION(:,:),INTENT(IN)::IELEM
...
INTEGER,ALLOCATABLE,DIMENSION(:),INTENT(IN)::XMPIELRANK
TYPE(A_CONNX),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ICONR,ICONRPA,ICONRPM,ICONRPF
TYPE(A_CONNX),ALLOCATABLE,DIMENSION(:),INTENT(INOUT)::ICONS,ICONSPO
REAL,dimension(1:dimensiona)::CORDS
