  ...
  !> This function returns the value of the basis function for a specific polynomial order and coordinates
    ...
    IF (POLY.EQ.1)THEN
        select case(number)
          ...
          case(1) ! FIRST ORDER FUNCTIONS (2ND-ORDER OF ACCURACY 3)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1

          case(2) ! SECOND ORDER FUNCTIONS (3RD-ORDER OF ACCURACY 4-9)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
          ...
          case(3) ! THIRD ORDER FUNCTIONS (4TH-ORDER OF ACCURACY  10-19)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
          ...
          case(4) ! FOURTH ORDER FUNCTIONS (5TH-ORDER OF ACCURACY 20-34)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
          ...
          case(5) ! FIFTH ORDER FUNCTIONS (6TH-ORDER OF ACCURACY 35-55)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
          ...
          case(6) ! SIXTH ORDER FUNCTIONS (7TH-ORDER OF ACCURACY 56-83)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
          ...
          case(7) ! SEVENTH ORDER FUNCTIONS (8TH-ORDER OF ACCURACY 84-119)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
          ...
          case(8) ! EIGHTH ORDER FUNCTIONS (9TH-ORDER OF ACCURACY 85-164)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
          ...
          case(9) ! NINTH ORDER FUNCTIONS (10TH-ORDER OF ACCURACY 165-219)
            SB(1)= X1
            SB(2)= Y1
            SB(3)= Z1	
            SB(4)= X1**2
    ...
    IF (POLY.EQ.2)THEN
        select case(number)
          ...
          case(8) ! EIGHTH ORDER FUNCTIONS (9TH-ORDER OF ACCURACY 120-164)
            SB(1)=-1 + 2*x1
            SB(2)=-1 + 2*y1
            SB(3)=-1 + 2*z1 
            SB(4)=1 - 6*x1 + 6*x1**2
