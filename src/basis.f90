...
FUNCTION BASIS_REC(N,X1,Y1,Z1,NUMBER,ICONSIDERED,NUMBER_OF_DOG,ICOMPWRT, IELEM_L, ILOCAL_RECON3_L, INTEG_BASIS_L,integ_basis_dg_L)
!> @brief
 ...
 case(6)
   ...
   select case (icompwrt)
    ...
    case(-2)
        ...
        basis_rec(1:NUMBER_OF_DOG) = SB(1:NUMBER_OF_DOG)-((INTEG_BASIS_DG_L(ICONSIDERED)%value(1:NUMBER_OF_DOG))*OOV)
    
    case(0)
        OOV=1.0D0/(ILOCAL_RECON3_L(ICONSIDERED)%VOLUME(1,1))
        basis_rec(1:NUMBER_OF_DOG)=SB(1:NUMBER_OF_DOG)-((INTEG_BASIS_L(ICONSIDERED)%value(1:NUMBER_OF_DOG))*OOV)
    
    case(1)
        OOV=1.0D0/(ILOCAL_RECON3_L(ICONSIDERED)%VOLUME(1,1))
        basis_rec(1:NUMBER_OF_DOG)=SB(1:NUMBER_OF_DOG)-((INTEG_BASIS_L(ICONSIDERED)%valuec(1:NUMBER_OF_DOG))*OOV)
...
FUNCTION BASIS_REC2d(N,X1,Y1,NUMBER,ICONSIDERED,NUMBER_OF_DOG,ICOMPWRT, IELEM_L, ILOCAL_RECON3_L, INTEG_BASIS_L, integ_basis_dg_L)
!> @brief
...
END SELECT
    ...
    case(-2)
        ...
        OOV=1.0D0/(IELEM_L(N,ICONSIDERED)%TOTVOLUME)
        basis_rec2d(1:NUMBER_OF_DOG) = SB(1:NUMBER_OF_DOG)-((INTEG_BASIS_DG_L(ICONSIDERED)%value(1:NUMBER_OF_DOG))*OOV)
    ...
    case(0)
        OOV=1.0D0/(ILOCAL_RECON3_L(ICONSIDERED)%VOLUME(1,1))
        basis_rec2d(1:NUMBER_OF_DOG)=SB(1:NUMBER_OF_DOG)-((INTEG_BASIS_L(ICONSIDERED)%value(1:NUMBER_OF_DOG))*OOV)
    
    case(1)
        OOV=1.0D0/(ILOCAL_RECON3_L(ICONSIDERED)%VOLUME(1,1))
        basis_rec2d(1:NUMBER_OF_DOG)=SB(1:NUMBER_OF_DOG)-((INTEG_BASIS_L(ICONSIDERED)%valuec(1:NUMBER_OF_DOG))*OOV)
