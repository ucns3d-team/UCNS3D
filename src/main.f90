...
1) MODIFY MULTISPECIES/NOF_SPECIES FOR DIFFUSION AS WELL AND NOF-VARIABLES (TT)-8E

2) RESTRUCTURE LSQ-DIRICHLET-NEUMANN  (TT)-3E

3) INVESTIGATE WHICH BC'S WE MOST LIKELY WANT FOR THE WALL (ISOTHERMAL (WORKS-EASY), CATALYTIC ETC)- (WP)

4) CONS2PRIM AND PRIM2CONS MODIFY TO BE MORE GENERIC (TEMPERATURE VECTOR TO BE INCLUDED) (TT)-5E

5) SOURCE REAL GAS CHECK IMPLEMENTATION (WP)

6) OUTPUT ROTATIONAL-TRANSLATIONAL AND VIBRATIONAL TEMPERATURE (TT)-2E

7) RIEMANN FIX HLLC/HLL/RUSANOV FOR REAL GAS (TT)-2E

8) SPECIFY WHAT VARIABLES TO EXPORT (WP) FOR ANALYSIS
