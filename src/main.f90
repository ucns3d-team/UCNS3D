...
IF (ISCHEME.GT.1)THEN
 ...
 IF (LOWMEM.EQ.1)CALL DETSTEN(N,ISIZE,IELEM,ISELEMT,XMPIELRANK,ILOCALALLS,TYPESTEN,ILOCALALLELG,ILOCALALLELGPER,STCON,STCONC,STCONS,STCONG,ISOSA,IX,&
 IISTART,IFSAT,PARE,DOSE,PAREEL,DOSEEL,PARES,SOSEEL,XMPIE,IFIN,TFIN,XMPIL,GLNEIGH,GLNEIGHPER)
 !$OMP END PARALLEL 
...
!$OMP PARALLEL DEFAULT(SHARED)
  ...
  IF (LOWMEM.EQ.1)CALL STENCIILS(N,IELEM,ILOCALALLELG,ILOCALALLELGPER,TYPESTEN,ILOCALSTENCIL,ILOCALSTENCILPER,NUMNEIGHBOURS,ISELEMT,XMPIE,XMPIELRANK,ISIZE,BC,VC,VG,ISATISFIED,&
  IWHICHSTEN,IPERIODICITY,XPER,YPER,ZPER,ISSF,ISHYAPE,XMPIL,CENTERR)
  end if
...
!$OMP END PARALLEL
  ...
  IF (N.EQ.0)THEN
    ...
    WRITE(133,'(1X,A2,1X,A11,A11,A11,A11,A11,A11,A11,A11,A11,A11)')"IT","T_TIME","T_COMM","T_COMP","T_DGINT","T_HALO","T_RECON","T_BOUND","T_ADDA","T_FLUX","T_UPDATE"
    CLOSE(133)
