...
!$omp& impdiag_mf, impoff_mf, impdiag, impdiagt, impdu, impdu_old, impoff, impofft, inoder4_bct, inoder4_cord, inoder4_itor, integ_basis_dg_value, integ_basis_value, integ_basis_valuec, m_1_val, modal_filter, modal_filter_strong, modal_filter_weak, &
